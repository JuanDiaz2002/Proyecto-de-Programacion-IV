...
$sql1="";
                ...
                {
                    $sql=" INSERT INTO `usuario`( `login`, `nombre`, `clave`, `correo`, `imagen`, `condicion`) VALUES ('$login','$nombre','$clave','$correo','$imagen',1)";
                  
                    $sql1=" INSERT INTO `usuario`( `login`, `nombre`, `clave`, `correo`, `imagen`, `condicion`) VALUES ('$login','$nombre','$clave','$correo','$imagen',1)";
...
case 'desactivar':
  ...
  /*     while ($reg1=$rspta1->fetch_object()){
        ...
        $rspta=$categoria->listar("select * from usuario where login='".$logina."' and clave='".$clavea."'");
        while ($reg=$rspta->fetch_object()){
            $_SESSION['bandera']="1";
            $idx=$reg->idusuario;
    ...
    break;
        case 'listar':
            $rspta=$categoria->listar("select * from  usuario order by nombre desc");
